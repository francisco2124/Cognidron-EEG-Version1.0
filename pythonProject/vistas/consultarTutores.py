...
"")
    ...
    def retranslateUi(self, Consultar_Terapeuta):
        ...
        self.label_2.setText(_translate("Consultar_Terapeuta", "Buscar Tutores: "))
        self.label_3.setText(_translate("Consultar_Terapeuta", "Reportes generales de tutores"))
        self.cbfiltrar.setItemText(0, _translate("Consultar_Terapeuta", "Nombre"))
        ...
        item.setText(_translate("Consultar_Terapeuta", "A. Paterno"))
        item = self.tableView_2.horizontalHeaderItem(2)
        item.setText(_translate("Consultar_Terapeuta", "A.Materno"))
        ...
        item.setText(_translate("Consultar_Terapeuta", "Correo electron."))
