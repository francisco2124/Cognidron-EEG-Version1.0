...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1101, 834)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/idea-genial.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MainWindow.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.mdiArea = QtWidgets.QMdiArea(self.centralwidget)
        self.mdiArea.setEnabled(True)
        self.mdiArea.setGeometry(QtCore.QRect(10, 20, 1071, 800))
        ...
        self.mdiArea.setMinimumSize(QtCore.QSize(1071, 800))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/archivo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconAbrirReporte.setIcon(icon1)
        ...
        self.actionVistaCuadricula.setIcon(icon2)
        self.actionVistaCuadricula.setObjectName("actionVistaCuadricula")
        self.actionBotonDetener = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/detener.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBotonDetener.setIcon(icon3)
        self.actionBotonDetener.setObjectName("actionBotonDetener")
        self.actionIconoTutor = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/familia.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconoTutor.setIcon(icon4)
        self.actionIconoTutor.setObjectName("actionIconoTutor")
        self.actionIconoTerapia = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/idea-genial.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconoTerapia.setIcon(icon5)
        self.actionIconoTerapia.setObjectName("actionIconoTerapia")
        self.actionIconLibro = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/libro-abierto.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconLibro.setIcon(icon6)
        ...
        self.actionVistaCascada.setIcon(icon7)
        self.actionVistaCascada.setObjectName("actionVistaCascada")
        self.actionIconPaciente = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/paciente.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconPaciente.setIcon(icon8)
        self.actionIconPaciente.setObjectName("actionIconPaciente")
        self.actionBotonPausa = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/images/pausa.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBotonPausa.setIcon(icon9)
        self.actionBotonPausa.setObjectName("actionBotonPausa")
        self.actionBotonPlay = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/images/play.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBotonPlay.setIcon(icon10)
        self.actionBotonPlay.setObjectName("actionBotonPlay")
        self.actionBotonEncender = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/images/poder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBotonEncender.setIcon(icon11)
        self.actionBotonEncender.setObjectName("actionBotonEncender")
        self.actionIconConsulatrReporte = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/images/reporte.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/images/salud-mental.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconoTerapia_2.setIcon(icon13)
        self.actionIconoTerapia_2.setObjectName("actionIconoTerapia_2")
        self.actionIconoTerapeuta = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/images/terapeuta.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconoTerapeuta.setIcon(icon14)
        self.actionIconoTerapeuta.setObjectName("actionIconoTerapeuta")
        self.actionIconoConexion = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/images/wifi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionIconoConexion.setIcon(icon15)
        self.actionIconoConexion.setObjectName("actionIconoConexion")
        self.actionConectar_Eotiv = QtWidgets.QAction(MainWindow)
        self.actionConectar_Eotiv.setObjectName("actionConectar_Eotiv")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/images/ventana.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionVistaVentana.setIcon(icon16)
        ...
        self.menuCoexion.addAction(self.actionConectar_Eotiv)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionConectar_Eotiv.setText(_translate("MainWindow", "Conectar Eotiv"))
