...
class Ui_NuevoPaciente(object):
    def setupUi(self, NuevoPaciente):
        ...
        self.ptDiagnostico.setGeometry(QtCore.QRect(440, 190, 301, 231))
        self.ptDiagnostico.setObjectName("ptDiagnostico")
        self.label_16 = QtWidgets.QLabel(NuevoPaciente)
        self.label_16.setGeometry(QtCore.QRect(440, 160, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
...
"background-color: rgb(200, 198, 223);")
        ...
        self.btnRegistrar.setGeometry(QtCore.QRect(640, 430, 101, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
