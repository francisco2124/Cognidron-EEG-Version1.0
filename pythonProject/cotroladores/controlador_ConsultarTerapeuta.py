...
from vistas.consultarTerapeuta import Ui_Consultar_Terapeuta
import datetime
import math
...
class Controlador_ConsultarTerapeutas(QtWidgets.QMainWindow):

    def __init__(self):
        super().__init__()
        print("soy la vista de consultar terapeutas")
        self.ui= Ui_Consultar_Terapeuta()
    ...
    def InicializarGui(self):
        ...
        self.ui.btnBuscarbaciente.clicked.connect(self.cargarTerapeutasXTerapeuta)
    ...
    def cargarCbPacientes(self):
        ...
        terapeutas =  self.modelo.recuperarTerapeutas()
        #print(terapeutas)
    ...
    def cargarTerapeutasXTerapeuta(self):
        teraselec = self.ui.cbfiltrar.currentText()
        print(teraselec)
        if teraselec == "Todos":
            self.cargarTerapeutas()
        else:
            datos2 = self.modelo.cargarTablaxTerapeuta(teraselec)
            print("cargar Reportes")
            i = len(datos2)
            self.ui.tableView_2.setRowCount(i)
            tablerow = 0
